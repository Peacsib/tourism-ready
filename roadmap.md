# Roadmap
- [x] Build full Tourism Workforce 2031 app (landing, onboarding, shell, all modules)
- [x] Redesign to light, more futuristic look (no dark UI)
- [x] Verify build and key flows
