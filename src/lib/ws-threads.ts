...
export type WsMessage = { id: string; role: "user" | "assistant"; content: string };
export type WsThread = { id: string; module: WorkspaceId; title: string; focus: string; updatedAt: number; messages: WsMessage[] };
